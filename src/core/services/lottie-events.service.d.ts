...
export declare class LottieEventsService implements OnDestroy {
     ...
     */
    animationCreated(animationItem: AnimationItem, animationCreated: EventEmitter<AnimationItem>): void;
    setAnimationItemAndLottieEventListeners(animationItem: AnimationItem, instance: BaseDirective): void;
